...
class ChartData(APIView):
    ...
    def get(self, request, format=None):
        ...
        labels6 = ["Doçent", "Endüstri Mühendisi", "Fabrika Müdürü", "İhracat Müşteri Temsilcisi", "İmalat Müdürü",
                   "Kalite Güvence Müdürü", "Kalite Güvence Mühendisi",
                   "Mühendis", "Öğretim Görevlisi", "Planlama Müdürü", "Planlama Mühendisi"]
        default_items6 = [m_count, m_count2, m_count3, m_count4, m_count5, m_count6, m_count7, m_count8, m_count9,
                          m_count10, m_count11]

        labels7 = ["Planlama Sorumlusu", "Profesör", "Proje Satış Uzmanı", "Satın Alma Mühendisi", "Satış Mühendisi",
                   "Satış Pazarlama Sorumlusu", "Üretim Mühendisi",
                   "Üretim Planlama Müdürü", "Üretim Planlama Mühendisi", "Üretim Planlama Sorumlusu", "Diğer"]
        default_items7 = [m_count12, m_count13, m_count14, m_count15, m_count16, m_count17, m_count18, m_count19,
                          m_count20, m_count21, m_count22]
        ...
        labels4 = ["Akademik", "Ambalaj", "Araştırma ve Geliştirme", "Yazılım ve Bilişim", "Danışmanlık", "Demir-Çelik",
                   "Elektrik & Elektronik", "Enerji", "Gıda", "Havacılık", "Hazır Giyim", "Holding/Şirketler Grubu",
                   "Isıtma,Havalandırma ve Klime", "İletişim"]
        default_items4 = [i_count, i_count2, i_count3, i_count4, i_count5, i_count6, i_count7, i_count8, i_count9,
                          i_count10,
                          i_count11, i_count12, i_count13, i_count14]

        labels5 = ["İnşaat", "Kimya Sanayi", "Logistik", "Makine", "Metal Sanayi", "Mobilya", "Oto Yedek Parça",
                   "Otomotiv", "Plastik ve Ürünleri", "Sağlık", "Tekstil", "Turizm ve Medya",
                   "Üretim/Endüstriyel Ürünler", "Yapı", "Diğer"]
        default_items5 = [i_count15, i_count16, i_count17, i_count18, i_count19, i_count20, i_count21, i_count22,
                          i_count23,
