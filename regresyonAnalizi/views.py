...
def machineLearning(request):
    ...
    polinomikresresyonmae = round(mean_absolute_error(y_test, linearregresyon2.predict(poly_reg.fit_transform(X_test))),
                                  4)
    polinomikresresyonmse = round(mean_squared_error(y_test, linearregresyon2.predict(poly_reg.fit_transform(X_test))),
                                  4)
    ...
    polinomikresresyonmae2 = round(
        mean_absolute_error(y_test, linearregresyon4.predict(poly_reg2.fit_transform(X_test))),
        4)
    polinomikresresyonmse2 = round(
        mean_squared_error(y_test, linearregresyon4.predict(poly_reg2.fit_transform(X_test))),
        4)
    ...
    return render(request, 'regresyonAnalizi/regresyonAnalizi.html',
                  {'sonuc': sonuc, 'sonuc2': sonuc2, 'sonuc3': sonuc3, 'sonuc4': sonuc4, 'ortalama': ortalama,
                   ...
                   'randomforestmae': randomforestmae, 'randomforestmse': randomforestmse,
                   'randomforestrmse': randomforestrmse,
                   'kararagacımae': kararagacımae, 'kararagacımse': kararagacımse, 'kararagacırmse': kararagacırmse,
                   'polinomikresresyonmae': polinomikresresyonmae, 'polinomikresresyonmse': polinomikresresyonmse,
                   'polinomikresresyonrmse': polinomikresresyonrmse,
                   'linearregresyonmae': linearregresyonmae, 'linearregresyonmse': linearregresyonmse,
                   'linearregresyonrmse': linearregresyonrmse,
