...
def traskriptIstekleri(request):
    for g in request.user.groups.all():
        ...
        if g.name == 'Bölüm Sekreteri':
            ...
            sekreter.save()
            return render(request, 'belgeler/transkriptIstekleri.html',
                          {'ogrenciIstekleri': ogrenciIstekleri, 'mezunIstekleri': mezunIstekleri,
                           'sekreter': sekreter})
    ...
    for g in request.user.groups.all():
        if g.name == 'Mezun' and istek == "1":
            ...
            return render(request, 'belgeler/transkriptIstekleriDetay.html',
                          {'mezunIstekleri': mezunIstekleri, 'form': form, 'tarih': tarih})
        ...
        if g.name == 'Öğrenci' and istek == "0":
            ...
            return render(request, 'belgeler/transkriptIstekleriDetay.html',
                          {'ogrenciIstekleri': ogrenciIstekleri, 'form': form, 'tarih': tarih})
        ...
        if g.name == 'Bölüm Sekreteri':
            if istek == "0":
                ...
                if form.is_valid():
                    ...
                    return redirect('belgeler:transkriptIstekleriDetay', ogrenciIstekleri.pk, 0)
                return render(request, 'belgeler/transkriptIstekleriDetay.html',
                              {'ogrenciIstekleri': ogrenciIstekleri, 'form': form, 'tarih': tarih, 'istek': istek})
                ...
                if form.is_valid():
                    ...
                    return redirect('belgeler:transkriptIstekleriDetay', mezunIstekleri.pk, 1)
                return render(request, 'belgeler/transkriptIstekleriDetay.html',
                              {'mezunIstekleri': mezunIstekleri, 'form': form, 'tarih': tarih, 'istek': istek})
            return render(request, 'belgeler/transkriptIstekleriDetay.html')
